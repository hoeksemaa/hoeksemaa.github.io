...
date: 2025 July
---
# hashbrowns: implemented from scratch

## Github
Stored neatly on [github](https://github.com/hoeksemaa/Hoeksema_Hash_Browns)

## Project Description
I implemented a basic hashmap data structure from scratch to learn how they work under the hood.

## Post-Mortem
- make sure the top-level data structure pieces fit together before building the internals
- release to users early and let them find the bugs
- aug 6: 
...
- you must FINISH the project: [joe barnard video](https://www.youtube.com/watch?v=4jgTCayWlwc)
