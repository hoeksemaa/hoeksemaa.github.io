...
Claude has me thinking about process. If I can describe a process, I can execute it somewhat mechanically:
1) Plan steps
2) Execute next step
3) Test the step
3) Reflect and improve
4) Loop 2-4 until all the steps are complete
...
- **Plan the car?** Deploy equations about structural loads, theories of safety systems, hopes of fuel efficiency. Consider what's worked in the past.
- **Construct the car?** Hire reputable construction crews; source reliable materials; build a factory.
- **Test whether the car is safe?** Start the car, measure the lights. Crash a couple cars on purpose to see how they behave.
- **Reflect and improve?** Try variations of elements and check to see if they're better. Instill culture of constant improvement in every factory worker and engineer.
